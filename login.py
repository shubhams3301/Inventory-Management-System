...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed By SDD TEAM E&TC-B Grp 6")
        ...
        lbl_forget=Label(register_frame,text="PBL GRP NO-6  DIV-B",font=("times new roman",13),bg="white").place(x=0,y=20,relwidth=1)
