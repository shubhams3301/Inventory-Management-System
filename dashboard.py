...
class IMS:
    def __init__(self,root):
        ...
        self.root.title("SDD Inventory Management System | Developed By SDD E&TC-B")

        #===Title===
        self.icon_title=PhotoImage(file="images/logo1.png")
        title=Label(self.root,text="SDD Inventory Management System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
...
#============================================================================
    ...
    def update_content(self):
        ...
        try:
            ...
            self.lbl_clock.config(text=f"Welcome to SDD Inventory Management System\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
